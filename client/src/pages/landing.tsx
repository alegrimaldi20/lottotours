      ...
      <footer className="bg-slate-900 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-slate-400 mb-4">
                Turn your wanderlust into real adventures through gamified travel experiences.
              </p>
            </div>
            <div>
              ...
              <ul className="space-y-2 text-slate-400">
                ...
                <li><Link href="/lotteries" className="hover:text-white transition-colors">Lotteries</Link></li>
          ...
          <div className="border-t border-slate-800 mt-8 pt-8 text-center text-slate-400">
            <p>&copy; 2024 TravelLotto. All rights reserved. Made with ❤️ for adventurers worldwide.</p>
          </div>
        </div>
      </footer>
    </div>
