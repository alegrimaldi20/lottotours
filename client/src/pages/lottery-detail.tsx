    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-pink-50 to-orange-50">
        ...
        <div className="max-w-6xl mx-auto px-4 py-6">
          <div className="flex items-center gap-4 mb-4">
            ...
            <Badge variant="secondary" className="bg-lottery-gold text-white">
              Draw #{lottery.drawId || `DRAW-${lottery.id.slice(-3)}`}
            </Badge>
          </div>
      ...
      <div className="max-w-6xl mx-auto p-4 space-y-8">
        ...
        <LotteryNumberSelector
          ...
          drawId={lottery.drawId || `DRAW-${lottery.id.slice(-3)}`}
          totalNumbers={lottery.totalNumbers || 49}
          numbersToSelect={lottery.numbersToSelect || 6}
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <ul className="text-sm text-slate-600 space-y-1">
                  <li>• Select {lottery.numbersToSelect || 6} numbers from 1 to {lottery.totalNumbers || 49}</li>
