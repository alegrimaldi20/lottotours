  ...
  const buyTickets = () => {
    ...
    ticketCart.forEach((ticket, index) => {
      const ticketData = {
        ...
        userId: "sample-user",
        ticketNumber: lottery.soldTickets + index + 1,
      ...
      .then(response => {
        if (response.ok) {
          ...
          errors.push(`Ticket ${index + 1}`);
        }
        
        // Check if all requests are done
        if (completedTickets + errors.length === ticketCart.length) {
          ...
          if (errors.length === 0) {
            ...
            toast({
              ...
              description: `${completedTickets} tickets comprados. Errores en: ${errors.join(', ')}`,
              variant: "destructive"
            });
          }
        }
