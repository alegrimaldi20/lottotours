  ...
  const buyTicketMutation = useMutation({
    mutationFn: async ({ lotteryId, ticketPrice }: { lotteryId: string; ticketPrice: number }) => {
      try {
        ...
        // Generate auto-selected numbers for lottery ticket
        ...
        console.error("Ticket purchase error details:", error);
        throw error;
      }
    },
    onSuccess: ({ ticket, totalCost }) => {
      toast({
        ...
        description: `Ticket #${ticket.ticketNumber} purchased successfully`,
      });
      
      // Refresh data without direct cache manipulation to avoid DOM issues
